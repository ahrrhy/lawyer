...
gulp.task('watch', ['css-libs', 'browser-sync', 'scripts', 'sass'], function () {
    gulp.watch('scss/**/*.+(scss|sass)', ['sass'], browserSync.reload);
    gulp.watch('stylesheets/*.css',  browserSync.reload);
    gulp.watch('template-parts/*.php', browserSync.reload); // Наблюдение за php файлами шаблонов
